...
type Base<M> = {
  [P in Extract<keyof M, string | symbol>]: (...args: any[]) => void
};
type Args<M, E extends keyof M> = M[E] extends (...args: infer A) => void
  ? A
  : never;
...
interface Methods<On, Emit> {
  addListener<E extends keyof On>(
    event: E,
    listener: Listener<On, E, this>
  ): this;
  addListener(event: never, listener: (...args: any[]) => void): this;
  removeListener<E extends keyof On>(
    event: E,
    listener: Listener<On, E, this>
  ): this;
  removeListener(event: never, listener: (...args: any[]) => void): this;
  prependListener<E extends keyof On>(
    event: E,
    listener: Listener<On, E, this>
  ): this;
  prependListener(event: never, listener: (...args: any[]) => void): this;
  prependOnceListener<E extends keyof On>(
    event: E,
    listener: Listener<On, E, this>
  ): this;
...
export type StrictBroadcast<T extends Evented<any, any>> = <
  E extends OnEventNames<T>
>(
  event: E,
