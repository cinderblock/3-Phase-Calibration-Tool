// Type definitions for nrf-intel-hex 1.3
// Project: https://github.com/NordicSemiconductor/nrf-intel-hex#readme
...
export default class MemoryMap {
   ...
   */
  static overlapMemoryMaps(memoryMaps: MemoryMap): Map<number, Uint8Array>;
  /**
   ...
   */
  static flattenOverlaps(overlaps: MemoryMap): MemoryMap;
  /**
